...
### Game Modifications
Unless explicitly stated within a specific modification's documentation:
* Our game modifications **do not collect, transmit, or store** any personal identification data or telemetry from your computer.
* Mod settings, configuration files, and saved states are stored locally on your own machine.
