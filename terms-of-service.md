...
> **IMPORTANT:** ALL MODS AND SERVICES ARE PROVIDED ON AN **"AS IS"** AND **"AS AVAILABLE"** BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED.

* **No Guarantee of Compatibility:** Game updates, official patches, or third-party software updates may render Mods incompatible or non-functional.
* **User Risk:** You acknowledge that modding video games carries inherent risks, including but not limited to game crashes, unexpected behavior, or potential save file corruption. You assume all responsibility and risk associated with installing and running Mods.
...
We reserve the right to revise or update these Terms at any time. Continued use of our website or Mods following any modifications constitutes acceptance of the updated Terms.

---

## 7. Governing Law & Contact

These Terms shall be governed in accordance with standard internet and software distribution practices. For support or questions regarding these Terms, please contact us through our official project channels (GitHub / Nexus Mods).
