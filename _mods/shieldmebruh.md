...
nexusmods_url: "https://www.nexusmods.com/valheim/mods/2272"
...
Never get caught in battle with an empty off-hand! **Shield Me Bruh!** is a sleek quality-of-life mod that seamlessly auto-equips your favorite shield whenever you draw any one-handed weapon (swords, axes, maces, spears, clubs, or knives).
...
* 📦 **Container Move Protection**: Quick-moving items into containers (<kbd>Ctrl</kbd> + Left Click) or bulk transfers will never accidentally strip the mark from your shield.
* ⚡ **Zero Lag Overhead**: Uses clean Harmony prefix/postfix hooks during item equip events with zero per-frame background polling.
...
| :--- | :--- |
| **AdventureBackpacks** | 🟢 Fully Supported (Equipped backpacks & quick transfer work seamlessly) |
| **FastItemTransfer** | 🟢 Fully Supported |
| **Equipment & Quick Slots** | 🟢 Fully Supported |
| **Epic Loot** | 🟢 Fully Supported (Enchanted shields remain marked) |
...
**Source Code**: [GitHub Repository](https://github.com/Vapok/ShieldMeBruh)  
**Community & Support**: [Discord Server](https://discord.gg/5YAJkRFBXt)  
**Changelog**: [Release Notes](https://github.com/Vapok/ShieldMeBruh/blob/main/CHANGELOG.md)
